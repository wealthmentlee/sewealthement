...
class Rate_Widget_BlogRateController extends Engine_Content_Widget_Abstract
{
  ...
  public function indexAction()
  {
    ...
    $select = $blogsTbl->select()->where('blog_id IN (?)', $this->item_ids);

    $items = $blogsTbl->fetchAll($select);
