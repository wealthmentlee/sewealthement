...
class Rate_Widget_EventRateController extends Engine_Content_Widget_Abstract
{
  ...
  public function indexAction()
  {
    ...
    $select = $eventsTbl->select()->where('event_id IN (?)', $this->item_ids);

    $items = $eventsTbl->fetchAll($select);
