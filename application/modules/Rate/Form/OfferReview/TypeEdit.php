 ...
 * @version    $Id: TypeEdit.php 2012-10-01 19:27 taalay $
 * @author     TJ
 */
...
class Rate_Form_OfferReview_TypeEdit extends Engine_Form
{
  public function init()
  {
    ...
    $this
      ...
      ->setDescription('RATE_OFFERS_REVIEW_TYPEEDIT_DESCRIPTION')
