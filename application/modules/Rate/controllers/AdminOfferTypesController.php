 ...
 * @version    $Id: AdminOfferTypesController.php 2012-10-01 19:27 taalay $
 * @author     TJ
 */
...
class Rate_AdminOfferTypesController extends Core_Controller_Action_Admin
{
  public function indexAction()
  {
    $this->view->navigation = Engine_Api::_()->getApi('menus', 'core')
      ->getNavigation('rate_admin_main', array(), 'rate_admin_main_offer_review');
    ...
    $categories = Engine_Api::_()->getApi('core', 'rate')->getOfferCategories();
    ...
    $form = new Rate_Form_OfferReview_TypeEdit();
  ...
  public function createAction()
  {
    ...
    $this->view->form = $form = new Rate_Form_OfferReview_TypeCreate();
