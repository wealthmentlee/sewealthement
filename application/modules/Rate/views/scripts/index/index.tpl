...
<?php
  $this->headScript()
    ->appendFile($this->baseUrl() . '/application/modules/Rate/externals/scripts/Rate.js');
?>

<script type="text/javascript">
en4.core.runonce.add(function(){
	var rateVar = new Rate(<?php echo "{$this->item->getIdentity()}, '{$this->item_type}', '{$this->rate_uid}', {$this->can_rate}"; ?>);
