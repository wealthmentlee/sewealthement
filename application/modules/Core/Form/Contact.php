...
class Core_Form_Contact extends Engine_Form
{
  ...
  {
    $description = "<b>Email Us: </b><br/>wealthment@gmail.com";  
    $this->setTitle('Need Some Assistance or Providing Feedback?')
    ...
    $this->addElement('Dummy','email_us',array(
       'content' => $description 
    ));
    ...
    $this->addElement('Select','option',array(
        'required' => true,
        'notEmpty' => true,
        'multiOptions' => array(
    ...
    $this->addElement('Text','category',array(
        'placeholder' => 'Question or Feedback Category (e.g., Password Issue, Stock Insights Feedback, etc.)',
        'required' => true,
        'notEmpty' => true,
    ));
