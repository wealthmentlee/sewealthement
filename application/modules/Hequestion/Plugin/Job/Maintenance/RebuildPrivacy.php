 ...
 * @version    $Id: RebuildPrivacy.php 17.08.12 06:04 michael $
 * @author     Michael
 */
...
class Hequestion_Plugin_Job_Maintenance_RebuildPrivacy extends Core_Plugin_Job_Abstract
{
  protected function _execute()
  {
    // Start custom prepare
    $table = Engine_Api::_()->getItemTable('hequestion');
