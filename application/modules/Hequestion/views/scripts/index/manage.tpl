 ...
 * @version    $Id: manage.tpl 17.08.12 06:04 michael $
 * @author     Michael
 */
?>
...
<div class="tip">
    <span>
      <?php echo $this->translate('HEQUESTION_NO_USER_QUESTIONS'); ?>
    </span>
</div>
<?php endif; ?>
...
<?php echo $this->paginationControl($this->paginator, null, array("pagination.tpl","hequestion"), array(
    'ajax_url' => $this->url(array('module' => 'hequestion', 'controller' => 'index', 'action' => 'manage', 'content' => 1), 'default', true),
