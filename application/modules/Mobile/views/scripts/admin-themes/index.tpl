    ...
    <div class="admin_theme_edit">
      ...
      <div class="admin_theme_header_controls">
        ...
        <div>
          ...
          <?php echo $this->htmlLink(array('route'=>'admin_default', 'module'=>'mobile', 'controller'=>'themes', 'action'=>'export','name'=>$this->activeTheme->name),
            $this->translate('Export'), array(
            'class' => 'buttonlink admin_themes_header_export',
            )) ?>
          <?php echo $this->htmlLink(array('route'=>'admin_default', 'module'=>'mobile', 'controller'=>'themes', 'action'=>'clone', 'name'=>$this->activeTheme->name),
