...
?>
<?php $core_422_n_high = (bool)substr($this->coreItem['version'], 0, 5)>= '4.2.2';?>
<?php if($core_422_n_high){ ?>
...
<script type="text/javascript">
  ...
  var confirmPageChangeLoss = function() {
    if( currentModifications.length == 0 ) return true;
  ...
  var saveChanges = function()
  {
    ...
    var url = '<?php echo $this->url(array('action' => 'update', 'controller' => 'content', 'module' => 'mobile'), 'admin_default', true)?>';
  ...
  var openWidgetParamEdit = function(name, element) {
    ...
    var url = '<?php echo $this->url(array('action' => 'widget', 'controller' => 'content', 'module' => 'mobile'), 'admin_default', true)?>';
  ...
  var saveCurrentPageInfo = function(formElement) {
    var url = '<?php echo $this->url(array('action' => 'save', 'controller' => 'content', 'module' => 'mobile'), 'admin_default', true)?>';
  ...
  {
    if( element.hasClass('admin_content_widget_mobile.container-tabs') ) {
      ...
      new Element('span', {
        ...
        'html' : contentByName["mobile.container-tabs"].childAreaDescription
      }).inject(element);
      // Edit area
  ...
  var deleteCurrentPage = function() {
    ...
    var url = '<?php echo $this->url(array('action' => 'delete', 'controller' => 'content', 'module' => 'mobile'), 'admin_default', true)?>';
    var request = new Request.JSON({
      'url' : url,
      'data' : {
        'format' : 'json',
...
<h2><?php echo $this->translate("Mobile Plugin") ?></h2>
...
<p>
  <?php echo $this->translate('MOBILE_ADMIN_DASHBOARD'); ?>
</p>
<br />

<h3><?php echo $this->translate('MOBILE_Layout Editor'); ?></h3>
<p>
  <?php echo $this->translate('MOBILE_LAYOUT_DESC'); ?>
</p>
                    ...
                    <td id="admin_content_<?php echo $structTwo['identity'] ?>" class="admin_content_column admin_content_buildable admin_content_<?php echo $structTwo['type'] . '_' . $structTwo['name'] ?>">
                      ...
                      <ul class="admin_content_sortable">
                        ...
                        ?>
                          ...
                          <?php elseif ($structThreeInfo['name'] == 'mobile.container-columns'): ?>
                            <!-- tabbed widgets -->
                            <li id="admin_content_<?php echo $structThree['identity'] ?>" class="admin_content_cell admin_content_buildable admin_content_draggable admin_layoutbox_widget_tabbed_wrapper admin_content_<?php echo $structThree['type'] . '_' . $structThree['name'] ?>">
                              <span class="admin_layoutbox_widget_tabbed_top">
                                <?php echo $this->translate('Columns Blocks') ?>
                                <span class="open">
                                  <a href='javascript:void(0);' onclick="openWidgetParamEdit('<?php echo $structThree['name'] ?>', $(this).getParent('li.admin_content_cell')); (new Event(event).stop()); return false;">
                                    <?php echo $this->translate('edit') ?>
                                  </a>
                              ...
                              <div class="admin_layoutbox_widget_tabbed">
																	<table><tr>
																		...
																		?>
																			...
																			<?php if ($structFourInfo['name'] == 'mobile.container-left'):?>
																					<td width="200px" valign="top" id="admin_content_<?php echo $structFour['identity'] ?>" class="admin_content_buildable admin_content_<?php echo $structFour['type'] . '_' . $structFour['name'] ?>"?>
																			<?php else: ?>
																					<td valign="top" id="admin_content_<?php echo $structFour['identity'] ?>" class="admin_content_buildable admin_content_<?php echo $structFour['type'] . '_' . $structFour['name'] ?>">
																			<?php endif; ?>
																			<span class="admin_layoutbox_widget_tabbed_overtext">
																				<?php echo $this->translate($structFourInfo['childAreaDescription']) ?>
																			</span>
																				...
																				<ul class="sortablesForceInclude admin_content_sortable admin_layoutbox_widget_tabbed_contents">
																					...
																					<?php
																						// LEVEL 5 - START (WIDGETS)
																						foreach( (array) $structFour['elements'] as $structFive ):
																								$structFiveNE = $structFive;
																								$structFiveInfo = @$this->contentByName[$structFive['name']];
																								unset($structFiveNE['elements']);
																					?>
																					<?php if( empty($structFiveInfo) ): ?>
																						<li id="admin_content_<?php echo $structFive['identity'] ?>" class="disabled admin_content_cell admin_content_buildable admin_content_draggable admin_content_<?php echo $structFive['type'] . '_' . $structFive['name'] ?>">
																							<?php echo $this->translate('Missing widget: %s', $structFive['name']) ?>
																							<span></span>
																						</li>
																					<?php else: ?>
																						<li id="admin_content_<?php echo $structFive['identity'] ?>" class="admin_content_cell admin_content_buildable admin_content_draggable admin_content_<?php echo $structFive['type'] . '_' . $structFive['name'] ?>">
																							<?php echo $this->translate($this->contentByName[$structFive['name']]['title']) ?>
																							<span class="open"> | <a href='javascript:void(0);' onclick="openWidgetParamEdit('<?php echo $structFive['name'] ?>', $(this).getParent('li.admin_content_cell')); (new Event(event).stop()); return false;">edit</a></span>
																							<span class="remove"><a href='javascript:void(0)' onclick="removeWidget($(this));">x</a></span>
																						</li>
																					<?php endif; ?>
																				<?php
                        ...
                        <script type="text/javascript">
                          window.addEvent('domready', function() {
                            $("admin_content_<?php echo $structThree['identity'] ?>").store('contentParams', <?php echo Zend_Json::encode($structThreeNE) ?>);
												...
												<?php if( empty($structThreeInfo['canHaveChildren']) ): ?>
                        <li id="admin_content_<?php echo $structThree['identity'] ?>" class="admin_content_cell admin_content_buildable admin_content_draggable admin_content_<?php echo $structThree['type'] . '_' . $structThree['name'] ?><?php if( !empty($structThreeInfo['special']) ) echo ' htmlblock' ?>">
                          <?php echo $this->translate($this->contentByName[$structThree['name']]['title']) ?>
