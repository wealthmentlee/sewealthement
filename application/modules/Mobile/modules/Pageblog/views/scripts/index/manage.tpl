                    ...
                    <li>
                      ...
                      <div class="item_body">
                        ...
                        <div class="item_options">
                          <a href="<?php echo $this->url(array('action' => 'delete', 'blog_id' => $blog->getIdentity(), 'return_url' => urlencode($_SERVER['REQUEST_URI'])), 'page_blog', true)?>"><?php echo $this->translate('Delete')?></a>
                        </div>
