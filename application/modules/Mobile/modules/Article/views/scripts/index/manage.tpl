 ...
 * @version    $Id: manage.tpl 2011-02-14 12:38:39 michael $
 * @author     Michael
 */
	...
	<div class="tabs">
		<ul>
			<?php foreach( $this->navigation as $item ): ?>
              ...
              <li class="<?php if ($article->featured) echo 'articles_browse_entry_featured'; ?> <?php if ($article->sponsored) echo 'articles_browse_entry_sponsored'; ?>">
                ...
                <div class='item_body'>
                  ...
                  <div class="item_options">
                    <a href="<?php echo $this->url(array('article_id' => $article->getIdentity()), 'article_delete')?>"><?php echo $this->translate('Delete')?></a>
                    <?php if ($article->isOwner($this->viewer) && !$article->isPublished()):?>
                      <br /><a href='<?php echo $this->url(array('article_id' => $article->article_id), 'article_publish', true) ?>'><?php echo $this->translate('Publish Article');?></a>
                    <?php endif;?>
                  </div>
