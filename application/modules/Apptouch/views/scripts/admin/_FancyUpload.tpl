 ...
 * @version    $Id: _FancyUpload.tpl 9930 2013-02-18 21:02:11Z jung $
 * @author     Sami
 */
?>
...
window.addEvent('domready', function() { // wait for the content
  ...
  var up = new FancyUpload2($('demo-status'), $('demo-list'), { // options object
    ...
    onComplete: function hideProgress() {
      ...
      var preview = document.getElementById("preview_html");
    ...
    onFileRemove: function(file) {
        ...
        request = new Request.JSON({
         'format' : 'json',
         'url' : '<?php echo $this->url(Array('module'=>'apptouch', 'controller' => 'admin-ads', 'action'=>'removephoto'), 'default') ?>',
         'data': {
           'photo_id' : file_id
         },
      ...
      $$('.content-adv')[0].innerHTML = '<?php echo $this->translate('Advertisement')?>';
...
//      demolist.innerHTML = '';
    ...
    onFileSuccess: function(file, response) {
      ...
      if (json.get('status') == '1') {
        ...
        var photo_img = json.get('photo_url');
        $('html_code').value = photo_img;
        $$('.content-adv')[0].innerHTML = photo_img;
        var demolist = document.getElementById("demo-list");
        demolist.innerHTML = '';
        demolist.grab(file.element);
      } else {
