...
<div class="admin_search apptouch_adcampaign_manage_form_container">
...
<?php if($this->campaign) { ?>
  ...
  <br />
  <div>
    <?php echo $this->htmlLink(array('action' => 'create', 'ad_campaign'=> $this->campaign_id, 'reset' => false),
    ...
    <?php foreach( $this->paginator as $item ): ?>
      <tr>
        ...
        <td class="admin_table_options">
          <a href='<?php echo $this->url(array('action' => 'create', 'id' => $item->ad_id)) ?>'>
            <?php echo $this->translate("edit") ?>
          </a> |
          <a class='smoothbox' href='<?php echo $this->url(array('action' => 'deletead', 'ad_id' => $item->ad_id)) ?>'>
