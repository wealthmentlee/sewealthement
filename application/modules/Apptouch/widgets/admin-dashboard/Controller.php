 ...
 * @license    http://www.socialengine.net/license/
 */
class Apptouch_Widget_AdminDashboardController extends Engine_Content_Widget_Abstract
{
  public function indexAction()
  {
    ...
    $this->view->appmanager = Engine_Api::_()->getDbTable('modules', 'core')->isModuleEnabled('appmanager');
  }
}