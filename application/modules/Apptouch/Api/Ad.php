<?php
class Apptouch_Api_Ad extends Core_Api_Abstract
{
  ...
  public function createPhoto($params, $file)
  {
    ...
    $row = Engine_Api::_()->getDbtable('Adphotos', 'apptouch')->createRow();
  ...
  public function deleteAd($ad){
    ...
    if ($ad->media_type == 0){
      // get photo row
      $ad_photo = Engine_Api::_()->getItem('apptouch_adphoto', $ad->photo_id);
      if( $ad_photo ){
        //delete storage item
