...
class Apptouch_Form_Signup_Account extends Engine_Form
{
...
//        &&  empty($_SESSION['janrain_signup'])
    ...
    if ($settings->getSetting('user.signup.terms', 1) == 1) {
      // Element: terms
      $description = Zend_Registry::get('Zend_Translate')->_('APPTOUCH_I have read and agree to the terms of service');
      $terms = Zend_Registry::get('Zend_Translate')->_('Terms of Service');
      $str = Zend_Registry::get('Zend_Translate')->_('_CORE_TERMS_OF_SERVICE');
...
CONTENT;
      ...
      $this->addElement('Dummy', 'termsText' , array(
        'content' => $content
      ));
