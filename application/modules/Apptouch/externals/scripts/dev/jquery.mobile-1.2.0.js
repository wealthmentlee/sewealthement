...
(function( $, window ) {
	...
	$.extend( $.mobile, {
      ...
      clearTimeout(window.loadingHide); // todo Ulan
...
/* Event Bindings - hashchange, submit, and click */
	...
	$.mobile.navreadyDeferred.done(function() {
		...
		$( document ).delegate( "form", "submit", function( event ) {
          ...
          role:$this.jqmData("rel"), // todo Ulan had changed
          cache:$this.jqmData("cache"), // todo Ulan had changed
					reloadPage:	true
				}
			);
			event.preventDefault();
        ...
        cache = $link.jqmData("cache"), //todo Ulan
      ...
      $.mobile.changePage(href, { transition:transition, reverse:reverse, role:role, /*todo Ulan { */cache:cache/* } todo Ulan */ });
			event.preventDefault();
		});
  ...
  _getChildrenByTagName:function (ele, lcName, ucName) {
          ...
          while (ele) {
            ...
            if (dict[ ele.nodeName ] ) {
              ...
              /**
               * todo Modification by Michael
               * todo Specially for Activity Feed
               * todo By Attribute "data-role=none" is except transforming of links
               */

              if (ele.attributes && ele.attributes["data-role"] && ele.attributes["data-role"].value == "none"){
