 ...
 */
class Apptouch_AdvgroupController
...
//  Member Controller {
  ...
  public function memberJoinAction()
  {
    ...
    // Make form
    $form = new Advgroup_Form_Member_Join();
    $this->add($this->component()->form($form))
      ->renderContent();
  ...
  public function memberRequestAction()
  {
    ...
    // Make form
    $form = new Advgroup_Form_Member_Request();
  ...
  public function memberCancelAction()
  {
    ...
    // Make form
    $form = new Advgroup_Form_Member_Cancel();
  ...
  public function memberLeaveAction()
  {
    ...
    // Make form
    $form = new Advgroup_Form_Member_Leave();
  ...
  public function memberAcceptAction()
  {
    ...
    // Make form
    $form = new Advgroup_Form_Member_Accept();
  ...
  public function memberRejectAction()
  {
    ...
    // Make form
    $form = new Advgroup_Form_Member_Reject();
  ...
  public function memberPromoteAction()
  {
    ...
    $form = new Advgroup_Form_Member_Promote();
  ...
  public function memberDemoteAction()
  {
    ...
    $form = new Advgroup_Form_Member_Demote();
  ...
  public function memberRemoveAction()
  {
    ...
    // Make form
    $form = new Advgroup_Form_Member_Remove();
  ...
  public function memberApproveAction()
  {
    ...
    // Make form
    $form = new Advgroup_Form_Member_Approve();
  ...
  public function memberEditAction()
  {
    ...
    // Make form
    $form = new Advgroup_Form_Member_Edit();
...
//          ->add($this->component()->paginator($paginator), 9)
  ...
  public function photoInit()
  {
    ...
    if (!Engine_Api::_()->core()->hasSubject()) {
      if (0 !== ($photo_id = (int)$this->_getParam('photo_id')) &&
        null !== ($photo = Engine_Api::_()->getItem('advgroup_photo', $photo_id))
      ) {
    ...
    $this->_helper->requireSubject->setActionRequireTypes(array(
      'photo-list' => 'group',
      'photo-upload' => 'group',
      'photo-view' => 'advgroup_photo',
      'photo-edit' => 'advgroup_photo',
    ));
  }
  ...
  public function photoUploadAction()
  {
    ...
    $form = new Advgroup_Form_Photo_Upload();
    ...
    {
      $values = $form->getValues();
      $photodb = Engine_Api::_()->getDbtable('photos', 'advgroup')->getAdapter();
  ...
  public function photoEditAction()
  {
    ...
    $form = new Advgroup_Form_Photo_Edit();
  ...
  public function postDeleteAction()
  {
    ...
    $form = new Advgroup_Form_Post_Delete();
...
//      ->add($this->component()->paginator($paginator))
  ...
  {
    if (!$this->_helper->requireSubject('advgroup_topic')->isValid()) return;
    if (!$this->_helper->requireAuth()->setAuthParams(null, null, 'view')->isValid()) return;
    ...
    if ($canPost && !$topic->closed) {
      $form = new Advgroup_Form_Post_Create();
      $form->populate(array(
  ...
  public function topicCreateAction()
  {
    ...
    // Make form
    $form = new Advgroup_Form_Topic_Create();
    $links = array(
      array(
        'label' => $group->getTitle(),
        'attrs' => array(
    ...
    try
    {
      ...
      // Add activity
      $activityApi = Engine_Api::_()->getDbtable('actions', 'activity');
      $action = $activityApi->addActivity($viewer, $topic, 'advgroup_topic_create', null, array('is_mobile' => true));
      if ($action) {
        $action->attach($topic);
      }
  ...
  public function topicPostAction()
  {
    ...
    if (!empty($quote_id)) {
      $quote = Engine_Api::_()->getItem('advgroup_post', $quote_id);
      if ($quote->user_id == 0) {
    ...
    try
    {
      ...
      // Activity
      $action = $activityApi->addActivity($viewer, $topic, 'advgroup_topic_reply', null, array('is_mobile' => true));
      if ($action) {
  ...
  public function topicRenameAction()
  {
    ...
    $form = new Advgroup_Form_Topic_Rename();
  ...
  public function topicDeleteAction()
  {
    ...
    $form = new Advgroup_Form_Topic_Delete();
