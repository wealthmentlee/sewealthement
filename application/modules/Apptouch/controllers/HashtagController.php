...
class Apptouch_HashtagController extends Apptouch_Controller_Action_Bridge
{

  public function indexSearchAction()
  {
    $name = $this->_getParam('name');
    $blocks_module  = $this->_getParam('blocks');
  ...
  {
    $table = Engine_Api::_()->getDbTable('tags', 'hashtag');
  }
}
