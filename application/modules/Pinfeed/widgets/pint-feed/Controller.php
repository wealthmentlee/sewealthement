...
class Pinfeed_Widget_PintFeedController extends Engine_Content_Widget_Abstract
{
  public  $pinfeed = 1;
  public function indexAction()
  {
    ...
    $this->view->width   = Engine_Api::_()->getApi('settings', 'core')->getSetting('Pinfeed.width',0);
