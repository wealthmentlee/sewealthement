 ...
 * @version    $Id: CommentController.php 18.06.12 10:52 michael $
 * @author     Michael
 */
...
class Wall_CommentController extends Core_Controller_Action_Standard
{
  ...
  public function createAction()
  {
    ...
    try {
      ...
      if (Engine_Api::_()->wall()->isPageModule($type)) {
    ...
    $this->view->body = $this->view->action('list', 'comment', 'wall', array(
      'type' => $this->_getParam('type'),
