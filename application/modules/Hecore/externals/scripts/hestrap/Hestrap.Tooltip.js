...
name: Hestrap.Tooltip

description: A simple tooltip implementation that works with the Twitter Hestrap css framework.
...
provides: [Hestrap.Twipsy, Hestrap.Tooltip]

...
*/

Hestrap.Tooltip = Hestrap.Twipsy = new Class({
