...
<script type="text/javascript">
  Wall.runonce.add(function (){
    new Wall.Items('wall-items', <?php echo $this->jsonInline(array('params' => array_merge($this->params, array('m' => $this->m, 'fn' => $this->fn))))?>);
  });
</script>
  ...
  <div class="total-header">
    ...
    <div class="header">
      <div class="header-title">
        <?php echo $this->translate('WALL_ITEMS_'.strtoupper($this->fn).'_HEADER_TITLE')?>
      </div>
      <div class="header-description">
        <?php echo $this->translate('WALL_ITEMS_'.strtoupper($this->fn).'_HEADER_DESCRIPTION')?>
      </div>
    </div>
