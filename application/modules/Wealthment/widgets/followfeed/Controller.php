...
class Wealthment_Widget_FollowfeedController extends Engine_Content_Widget_Abstract
{
  ...
  public function indexAction()
  {
    ...
    do {
      ...
      if ($customStreamClass){
		...
		$actions = array();
		$acts = Engine_Api::_()->getDbTable('follows','wealthment')->getActionsOfFollower($subject); 
		if(count($acts) <= 0){
			return $this->setNoRender();
		}
		$actions = Engine_Api::_()->getItemMulti('activity_action',$acts);
