...
class Zend_Navigation_Page_Mvc extends Zend_Navigation_Page
{
    ...
    public function isActive($recursive = false)
    {
        if (!$this->_active) {
            ...
            if (null !== $this->_module) {
                $myParams['module'] = $this->_module;
            } else if( !empty($defParams['module']) ) {
            ...
            if (null !== $this->_controller) {
                $myParams['controller'] = $this->_controller;
            } else if( !empty($defParams['controller']) ) {
            ...
            if (null !== $this->_action) {
                $myParams['action'] = $this->_action;
            } else if( !empty($defParams['modactionule']) ) {
            ...
            // [START] Modified by webligo developments
            if( $this->getHref() == $_SERVER['REQUEST_URI'] ||
                $this->getHref() == $front->getRequest()->getPathInfo() ) {
                $this->_active = true;
                return true;
            }
            // [END] Modified by webligo developments
