 ...
 * @version    $Id: Subform.php 18.06.12 10:52 michael $
 * @author     Michael
 */
...
class Wall_Form_Subform extends Zend_Form_SubForm
{
    /**
  ...
  public function loadDefaultDecorators()
  {
    ...
    if( empty($decorators) )
    {
      $this
        ...
        ->addDecorator('FormContainer', array('tag' => 'div', 'class' => 'wall-subform-wrapper'))
