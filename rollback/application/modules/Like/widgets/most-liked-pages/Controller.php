...
class Like_Widget_MostLikedPagesController extends Engine_Content_Widget_Abstract
{
  public function indexAction()
  {
    ...
    $ipp = $settings->getSetting('like.page_count', 9);
    $this->view->period = $period = $settings->getSetting('like.page_period', 1);
