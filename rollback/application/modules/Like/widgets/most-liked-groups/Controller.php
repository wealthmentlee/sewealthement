...
class Like_Widget_MostLikedGroupsController extends Engine_Content_Widget_Abstract
{
  public function indexAction()
  {
    ...
    $ipp = $settings->getSetting('like.group_count', 9);
    $this->view->period = $period = $settings->getSetting('like.group_period', 1);
