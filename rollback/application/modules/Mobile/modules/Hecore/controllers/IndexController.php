...
class Hecore_IndexController extends Core_Controller_Action_Standard
{
  public function init()
  {
    ...
    $this->view->p = $p = (int)$this->_getParam('p', $this->_getParam('page', 1));
    ...
    $this->view->ipp = $ipp = (int)$this->_getParam('ipp', 5);
    $this->view->action_url = urldecode($this->_getParam('action_url'));
