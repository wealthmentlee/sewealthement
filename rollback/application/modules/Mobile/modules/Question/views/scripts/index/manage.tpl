 ...
 * @version    $Id: manage.tpl 2011-02-16 10:08:38 michael $
 * @author     Michael
 */
			...
			<?php foreach( $this->navigation as $item ): ?>
                  ...
                  <div class="item_body">
                    ...
                    <div class="item_options">
                      ...
                      <?php if ($question->status == 'open'): ?>
                        ...
                        <a href='<?php echo $this->url(array('question_id' => $question->question_id), 'question_edit', true) ?>'>
                          <?php echo $this->translate('Edit');?>
                        </a><br />

                        <?php echo $this->htmlLink(array('route' => 'default', 'module' => 'question', 'controller' => 'index', 'action' => 'cancel', 'id' => $question->question_id, 'return_url' => urlencode($_SERVER['REQUEST_URI'])), 'Cancel') ?><br />

                      <?php endif; ?>
                      <?php if ($this->can_delete): ?>

                      <?php echo $this->htmlLink(array('route' => 'default', 'module' => 'question', 'controller' => 'index', 'action' => 'deleteq', 'id' => $question->question_id, 'return_url' => urlencode($_SERVER['REQUEST_URI'])), 'Delete') ?>
                      <?php endif; ?>
              ...
              <?php endforeach ;?>
                ...
                <?php endif; ?>
						...
						<?php echo $this->paginationControl($this->paginator, null, array('pagination/search.tpl', 'mobile'), array('query' => array('search' => $this->search))); ?>
