...
<h4>&raquo; <?php echo $this->translate('%1$s\'s Album: %2$s', $this->album->getOwner()->__toString(), $this->htmlLink($this->album, $this->album->getTitle())); ?></h4>
  ...
  <p class="description">
	...
	<div>
		...
		<?php if ($this->album->count() > 1): ?>
			...
			<ul class="paginationControl">
				<li class="paginator_previous">
					<a href="<?php echo $this->previousPhoto->getHref(); ?>" style="display: inline-block">
				...
				<li class="paginator_next">
					<a href="<?php echo $this->nextPhoto->getHref(); ?>" style="display: inline-block">
		...
		<div class='photo_view_container'>
			...
			<div class="photo">
				<a href='<?php echo $this->escape($this->nextPhoto->getHref()) ?>'>
