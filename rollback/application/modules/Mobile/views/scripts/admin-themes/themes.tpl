 ...
 * @version    $Id: themes.tpl 2011-02-14 06:58:57 mirlan $
 * @author     Mirlan
 */
...
<?php else: ?>
  ...
  <div class="tip">
    <span>
      ...
      <?php echo $this->translate("CORE_VIEWS_SCRIPTS_ADMINTHEMES_THEMES_TIP","application/modules/Mobile/themes/" . $this->active) ?>
    ...
    <ul class="admin_themes">
      <?php foreach( $this->themes as $dir => $theme ):
        ...
        if( !empty($theme['meta']['thumb']) && file_exists("{$theme['basepath']}/{$theme['meta']['thumb']}")) {
            $thumb = "application/modules/Mobile/themes/$dir/{$theme['meta']['thumb']}";
        }
        ?>
