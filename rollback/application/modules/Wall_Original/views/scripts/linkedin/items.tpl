...
<?php if (empty($this->stream) || empty($this->stream['_total'])):?>
...
<?php foreach ($this->stream['values'] as $action):?>

<li class="wall_linkedin_item">
  <?php
  $this->action = $action;
  echo $this->render('linkedin/item.tpl');
  ?>
</li>
