/* $Id: composer_music.js 18.06.12 10:52 michael $ */



Wall.Composer.Plugin.Music = new Class({
  ...
  activate : function() {
    ...
    this.elements.form = new Element('form', {
      'class' : 'wall-compose-form wall-compose-music-form',
      'method' : 'post',
      'action' : fullUrl,
    ...
    this.elements.formInput = new Element('input', {
      'class' : 'wall-compose-form-input wall-compose-music-form-input',
      'type' : 'file',
      'name' : 'Filedata',
      'events' : {
    ...
    if( this.options.fancyUploadEnabled && this.options.fancyUploadOptions ) {
      ...
      this.elements.formFancyFile = new Element('a', {
        ...
        'class' : 'buttonlink wall-compose-music-form-fancy-file',
...
'<div style="display:none;">\n\
  ...
  <div class="current-text"></div>\n\
    ...
    this.elements.formSubmit = new Element('button', {
      'id' : 'wall-compose-music-form-submit',
  ...
  doProcessResponse : function(responseJSON) {
    ...
    this.elements.preview = Asset.image(responseJSON.src, {
      'id' : 'wall-compose-video-preview-image',
      'class' : 'wall-compose-preview-image',
    ...
    */
    ...
    this.elements.preview = new Element('a', {
      ...
      'class': 'wall-compose-music-link',
      'events' : {
        'click' : function(event) {
          event.stop();
          $(this).toggleClass('wall-compose-music-link-playing');
          $(this).toggleClass('wall-compose-music-link');
