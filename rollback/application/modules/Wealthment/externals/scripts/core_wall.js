...
Wall.globalBind = function ()
{
  window.addEvent('domready', function (){
    ...
    try {
      ...
      window.clearTimeout(window.PinfeedTimeout);
      window.PinfeedTimeout = setTimeout(function (){
      window.clearTimeout(window.wallTimeout);
...
Wall.Feed = new Class({
  ...
  initStream: function ()
  {
    ...
    pinfeed_types_event =this.pinfeed_types_event= $('pinfeed_types');
  ...
  initAction: function ($container, params)
  {
    ...
    $container.getElements('.wall-comment-form').removeEvent('submit').addEvent('submit', function (e){
      ...
      values += '&comment_pagination=' + action_element.comment_pagination + '&checkin=' + element.checkin + '&pinfeed=1';
  ...
  loadList: function (html)
  {
    ...
    this.$types.getElements('.item').addEvent('click', function (){
      ...
      if (rev.substr(0, 4) == 'type'){
        ...
        pinfeed_types_event.getElements('a').removeClass('active');
        pinfeed_types_event.getElements('li').removeClass('active');
        $(this).addClass('is_active');
        $('pinfeed_menu_more').addClass('active');
        $$('.wall-list-button').addClass('active');
        $('pinfeed_more').setStyle('color','#fff');
        var text_more = $(this).getElement('.wall_text').get('html')+'<i class="icon-chevron-down"></i>';
...
*/
          $('pinfeed_more').set('html','<span class="pinfeed_loader" style="display: inline-block;  margin-top: -2px;"></span><i class="icon-chevron-down"></i>');
          $loader.addClass('wall_loading');
          self.loadFeed(self.params, null, function (){
              $loader.removeClass('wall_loading');
              $('pinfeed_more').set('html',text_more);
          });
        ...
        /*$loader.getElement('.wall_icon').set('class', 'wall_icon').addClass('wall-type-list');
        $loader.getElement('.wall_text').set('html', $(this).getElement('.wall_text').get('html'));*/
          $$('.pinfeed_loader').setStyle('display','block')
        $loader.addClass('wall_loading');
        self.loadFeed(self.params, null, function (){
          $loader.removeClass('wall_loading');
            $$('.pinfeed_loader').setStyle('display','none')
        });
        ...
        self.params.list_id = 0;
          ...
          self.loadFeed(self.params, null, function (){
              $loader.removeClass('wall_loading');
              $('pinfeed_more').set('html',en4.core.language.translate('More')+'<i class="icon-chevron-down"></i>');
          });
      ...
      this.pinfeed_types_event.getElements('.item').addEvent('click', function (){

      var rev = $(this).get('rev');

      if (rev.substr(0, 4) == 'type'){

        /*self.pinfeed_types_event.getElements('a').removeClass('is_active');
        $(this).addClass('active');*/
        self.pinfeed_types_event.getElements('li').removeClass('active');
        self.pinfeed_types_event.getElements('a').removeClass('active');
        $(this).getParent().addClass('active');
        $(this).addClass('active');
         // $('pinfeed_more').setStyle('color','#555555');
          $('pinfeed_more').setStyle('color',null);
        $('pinfeed_more').set('html',en4.core.language.translate('More')+'<i class="icon-chevron-down"></i>');
    ...
    var request_fn = function (html){
     ...
     if(pinfeed_page==1){
        ...
        self.initAction($feed, params);
          /*if(!$$('.pinfeed').getChildren('.utility-viewall')){

             $(' <li class="utility-viewall"> <div class="pagination"> <a rev="next_302" href="javascript:void(0);" class="wp_init">View More</a> </div> <div style="display: none;" class="loader"> <div class="wall_icon"></div> <div class="text"> Loading ...</div> </div></li>').inject($('pinfeed'), 'bottom');
          }*/
...
alert(' m i here in wealthment');
      ...
      Wall.request(en4.core.baseUrl + 'wall/index/post?pinfeed=1', this.getForm().toQueryString(), function (obj){
